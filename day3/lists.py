...
vowels[-1] = "U" # Assigning item to the last position with negative indexing
...
# In every data-types operations, methods and built-in functions should be
